...
# Получаем токены из переменных окружения или используем прямо закодированные
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "8660383498:AAE2-bs39uohcSrwx-HVW5li3S4cmeY1k1g")
ANTHROPIC_API_KEY = os.getenv("ANTHROPIC_API_KEY", "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")

# Логируем что токены загружены
...
async def help_handler(message: Message):
    ...
    await message.reply(
        "ℹ️ Как использовать:\n\n"
        "1️⃣ Напиши вопрос или текст\n"
        "2️⃣ Получи ответ от Claude AI\n"
        "3️⃣ История сохраняется в сессии\n\n"
        "📝 Команды:\n"
        "/start - начало\n"
        "/clear - очистить историю\n"
        "/help - эта справка"
